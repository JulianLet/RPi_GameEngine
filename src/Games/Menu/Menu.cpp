...
{
    myInputSystem.Update(world, deltaTime);
    actionSystem.Update(world); 
    myUIButtonSystem.Update(world, deltaTime);
    
    if (runGame)
    {
        myAISystem.Update(world, deltaTime);
        myCameraSystem.Update(world, deltaTime);
        myTilemapSystem.Update(world, deltaTime);
        ...
        myCollisionSystem.Update(world, deltaTime);
        ...
        myUITimerSystem.Update(world, deltaTime);
    }
}
